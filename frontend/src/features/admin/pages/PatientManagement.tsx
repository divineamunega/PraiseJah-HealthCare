    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          ...
          {
            label: "CRITICAL",
            value: patients.filter((p) => p.name.includes("Lucy")).length,
            icon: AlertCircle,
            color: "text-red-400",
          },
          {
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b border-white/5">
              <th className="px-6 py-4 mono-label text-on-surface-variant">
                PATIENT
              </th>
              <th className="px-6 py-4 mono-label text-on-surface-variant">
                AGE/SEX
              ...
              <th className="px-6 py-4 mono-label text-on-surface-variant text-right">
                STATUS
              </th>
              <th className="px-6 py-4 mono-label text-on-surface-variant text-right">
                ACTION
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    <span
                      className={`data-value text-[8px] px-2 py-0.5 border ${statusColors[status]}`}
                    >
                      {status}
                    </span>
                  </td>
